    ...
    <div class="max-w-5xl" x-data="poForm()">
        <form method="POST" action="{{ route('purchasing.store') }}">
            ...
            <div class="space-y-5">
                ...
                <x-card title="Informasi Purchase Order" subtitle="Pilih supplier rekanan dan estimasi jadwal kedatangan barang" variant="primary">
                ...
                <x-card title="Daftar Komponen / Bahan Dipesan" subtitle="Tentukan bahan baku dan nilai tagihan yang disepakati" :noPadding="true">
                    <div class="overflow-visible">
                        <table class="w-full text-xs">
                            <thead class="bg-gray-50 border-b border-gray-200 text-gray-700 font-semibold uppercase text-[11px] tracking-wider">
                                <tr>
                                    <th class="px-4 py-3 text-left w-[48%]">Bahan Baku / Komponen <span class="text-rose-500">*</span></th>
                                    <th class="px-4 py-3 text-right w-44">Qty Order <span class="text-rose-500">*</span></th>
                                    <th class="px-4 py-3 text-right w-52">Harga Total (Rp) <span class="text-rose-500">*</span></th>
                                        ...
                                        <td class="px-4 py-2.5">
                                            <div
                                                x-data="productSearchSelect({
                                                    ...
                                                    placeholder: '— Cari & Pilih Bahan / Kemasan (Paginasi 10) —',
                    ...
                    <div class="px-4 py-3 bg-gray-50/50 border-t border-gray-200 flex items-center justify-between">
                        <x-button type="button" @click="rows.push({produk_id:'',qty:'',harga:'',satuan:'',selectedItem:null})" variant="secondary" size="xs">
                            <x-slot:icon>
                    ...
                    <x-slot:footer>
                        <div class="flex items-center justify-end gap-2.5">
                            <x-button href="{{ route('purchasing.index') }}" variant="secondary" size="sm">
                                Batal
                            </x-button>
