<x-app-layout title="Laporan Produksi">
    ...
    <h3 class="text-lg font-semibold text-gray-900 mt-4 mb-6">Laporan Produksi</h3>
    <div class="bg-white rounded-xl border border-gray-200 overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-200"><tr>
                ...
                <th class="px-4 py-3 text-right font-medium text-gray-600">Yield</th>
            </tr></thead>
            <tbody>
                ...
                <tr class="border-b border-gray-100">
                    ...
                    <td class="px-4 py-2">{{ $b->tanggal->format('d/m/Y') }}</td>
                    <td class="px-4 py-2 text-right">{{ rtrim(rtrim(number_format($b->qty_rencana,2),'0'),'.') }}</td>
                    ...
                    <td class="px-4 py-2 text-right">{{ $b->yield() !== null ? number_format($b->yield(),1).'%' : '-' }}</td>
                </tr>
                @empty
                <tr><td colspan="7" class="px-4 py-6 text-center text-gray-400">Belum ada batch selesai.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
